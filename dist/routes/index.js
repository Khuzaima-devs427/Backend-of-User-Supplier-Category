...
// ========== SUPPLIER CATEGORY ROUTES ==========
router.post('/supplier-categories', supplierCategoryController_1.createSupplierCategory);
...
router.put('/supplier-categories/:id', supplierCategoryController_1.updateSupplierCategory);
