...
exports.User = exports.SupplierCategory = exports.UserCategory = exports.PERMISSIONS = void 0;
...
const SupplierCategorySchema = new mongoose_1.Schema({
    name: {
        type: String,
        required: true,
        trim: true
...
UserSchema.pre('save', async function (next) {
    if (this.supplierCategory) {
        try {
            const userCat = await mongoose_1.default.model('UserCategory').findById(this.userType);
            if (!userCat || userCat.categoryType !== 'Supplier') {
                return next(new Error('Suppliers must have a user category of type "supplier"'));
            }
        }
        catch (error) {
            return next(error);
...
// ==================== MODELS ====================
exports.UserCategory = mongoose_1.default.model('UserCategory', UserCategorySchema);
exports.SupplierCategory = mongoose_1.default.model('SupplierCategory', SupplierCategorySchema);
exports.User = mongoose_1.default.model('User', UserSchema);
// ==================== EXPORT ALL ====================
exports.default = {
    UserCategory: exports.UserCategory,
    SupplierCategory: exports.SupplierCategory,
    User: exports.User
};
// models/UnifiedModel.ts
